import 'package:e_commerce_food/controler/home_controler.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<ItemModel> _hottestItems = [
    ItemModel(
      imgPath: ManagerImage.quinoaFruitSalad,
      title: 'Quinoa fruit salad',
      price: 2000,
      color: Color(0xffFFFCF2),
    ),
    ItemModel(
      imgPath: ManagerImage.tropicalFruitSalad,
      title: 'Tropical fruit salad',
      price: 2000,
      color: Color(0xffFEF4F4),
    ),
    ItemModel(
      imgPath: ManagerImage.melonFruitSalad,
              ...
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(
                    height: 400,
                    child: Row(
                      children: List.generate(_recommendedItems.length, (
                        index,
                      ) {
                        ...
                        children: [
                          Column(
                            children: [
                              TextButton(
                                onPressed: () {
                                  value.updateIndexSelect(index: 0);
                                },
                                child: Text(
                                  "Hottest",
                                  style: GoogleFonts.roboto(
                                    fontSize: 30,
                                    fontWeight: value.indexSelect == 0
                                        ? FontWeight.w500
                                        : FontWeight.w300,
                                    color: value.indexSelect == 0
                                        ? Color(0xff27214D)
                                        : Color(0xff253F66),
                                  ),
                                ),
                              ...
                              AnimatedContainer(
                                ...
                                height: 2,
                                width: value.indexSelect == 0 ? 90 : 0,
                                decoration: BoxDecoration(
                                  color: Colors.orange,
                          ...
                          Column(
                            children: [
                              TextButton(
                                onPressed: () {
                                  value.updateIndexSelect(index: 1);
                                },
                                child: Text(
                                  "Popular",
                                  style: GoogleFonts.roboto(
                                    fontSize: 30,
                                    fontWeight: value.indexSelect == 1
                                        ? FontWeight.w500
                                        : FontWeight.w300,
                                    color: value.indexSelect == 1
                                        ? Color(0xff27214D)
                                        : Color(0xff253F66),
                                  ),
                                ),
                              ...
                              AnimatedContainer(
                                duration: const Duration(milliseconds: 250),
                                height: 2,
                                width: value.indexSelect == 1 ? 90 : 0,
                                decoration: BoxDecoration(
                                  color: Colors.orange,
                                  borderRadius: BorderRadius.circular(10),
                                ),
                          ...
                          Column(
                            children: [
                              TextButton(
                                onPressed: () {
                                  value.updateIndexSelect(index: 2);
                                },
                                child: Text(
                                  "New Combo",
                                  style: GoogleFonts.roboto(
                                    fontSize: 30,
                                    fontWeight: value.indexSelect == 2
                                        ? FontWeight.w500
                                        : FontWeight.w300,
                                    color: value.indexSelect == 2
                                        ? Color(0xff27214D)
                                        : Color(0xff253F66),
                                  ),
                                ),
                              ...
                              AnimatedContainer(
                                duration: const Duration(milliseconds: 250),
                                height: 2,
                                width: value.indexSelect == 2 ? 90 : 0,
                                decoration: BoxDecoration(
                                  color: Colors.orange,
                                  borderRadius: BorderRadius.circular(10),
                                ),
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                      itemCount: _hottestItems.length,
                      padding: const EdgeInsets.only(right: 8),
                      itemBuilder: (context, index) {
                        final ItemModel item = _hottestItems[index];
                        final bool isFavorited = _favorites.contains(index);
                        final bool isInCart = _cartItems.contains(index);
